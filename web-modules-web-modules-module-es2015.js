...
const routes = [
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | manager-manager-module */ "manager-manager-module").then(__webpack_require__.bind(null, /*! ./manager/manager.module */ "./src/app/web-modules/manager/manager.module.ts")).then(m => m.ManagerModule)
    },
    //other required modules as pe the image provided in sidebar
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | news-news-module */ "news-news-module").then(__webpack_require__.bind(null, /*! ./news/news.module */ "./src/app/web-modules/news/news.module.ts")).then(m => m.NewsModule)
    },
    {
        path: _constant_routeconstant__WEBPACK_IMPORTED_MODULE_3__["RouteConstant"].manageBenifits,
        loadChildren: () => __webpack_require__.e(/*! import() | benifits-benifits-module */ "benifits-benifits-module").then(__webpack_require__.bind(null, /*! ./benifits/benifits.module */ "./src/app/web-modules/benifits/benifits.module.ts")).then(m => m.BenifitsModule)
    },
    {
        path: _constant_routeconstant__WEBPACK_IMPORTED_MODULE_3__["RouteConstant"].calender,
        loadChildren: () => __webpack_require__.e(/*! import() | calender-calender-module */ "calender-calender-module").then(__webpack_require__.bind(null, /*! ./calender/calender.module */ "./src/app/web-modules/calender/calender.module.ts")).then(m => m.CalenderModule)
    },
    {
        path: _constant_routeconstant__WEBPACK_IMPORTED_MODULE_3__["RouteConstant"].gaols,
        loadChildren: () => __webpack_require__.e(/*! import() | goals-goals-module */ "goals-goals-module").then(__webpack_require__.bind(null, /*! ./goals/goals.module */ "./src/app/web-modules/goals/goals.module.ts")).then(m => m.GoalsModule)
    },
    {
        path: _constant_routeconstant__WEBPACK_IMPORTED_MODULE_3__["RouteConstant"].learning,
        loadChildren: () => __webpack_require__.e(/*! import() | learning-learning-module */ "learning-learning-module").then(__webpack_require__.bind(null, /*! ./learning/learning.module */ "./src/app/web-modules/learning/learning.module.ts")).then(m => m.LearningModule)
    },
    {
        path: '',
...
let WebModulesRoutingModule = class WebModulesRoutingModule {
};
...
let WebModulesModule = class WebModulesModule {
};
